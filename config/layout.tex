...
\renewcommand{\maketitle}[5] {
  ...
  \centering
   ...
   % 
    {\Large \textbf{Internship Report}}\\ \Large{\textbf{on}} \\
    \Large \textbf{Mobile Software Development and OOP}
    ...
    \begin{minipage}{\textwidth}
      ...
      \\ [14pt]
      Supervisor and Organization Contact: \\ Christian Motz \\ christian.motz@favendo.com
      \\[12pt] Bamberg, \today 
      \\[40pt]
